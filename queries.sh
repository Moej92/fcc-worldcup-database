...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON games.winner_id = teams.team_id OR teams.team_id = games.opponent_id WHERE round = 'Eighth-Final' AND year = 2014 ORDER BY name")"
